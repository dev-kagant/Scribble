...
function MobileNavComponent({links}) {
  ...
  return (
    <div className='flex flex-col w-1/2 h-screen pr-0 '>
      ...
      {activeMenu ? (
      <nav className='flex flex-col justify-start absolute top-11.5 w-full h-auto opacity-95 text-teal-600 font-skinny text-2xl border-2 border-solid border-teal-800'>
